...
- [Architecture Decision Records (ADRs)](./adr/) - Formal records of architectural decisions, trade-offs, and rationale.

## 🛠️ Operations & Maintenance
Guides for deploying, monitoring, and troubleshooting the system.
- [Observability Runbook](./runbooks/) - Procedures for monitoring system health via Grafana, managing Kafka offsets, and handling pipeline failures.

## 📊 Data Specifications
Definitions of our internal data structures and external integrations.
...
---
*Note: This index is automatically updated as new documentation modules are added to the system.*
