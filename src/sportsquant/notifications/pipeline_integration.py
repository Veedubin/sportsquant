...
Add this to your analysis pipeline to send alerts:
    ...
    from sportsquant.notifications.pipeline_integration import send_ev_alerts_from_pipeline
    send_ev_alerts_from_pipeline(pipeline, site="PrizePicks")

    # For evaluator results
    from sportsquant.notifications.pipeline_integration import EvaluatorNotifier
...
from sportsquant.notifications.models import EVAlert
from sportsquant.notifications.service import NotificationService, create_from_pipeline_result
