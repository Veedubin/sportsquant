"""Async read-side query helpers for the SportsQuant web UI.

Mirrors the write-side layer in :mod:`~sportsquant.infra.db.writers` —
...
:class:`~sportsquant.infra.db.connection.DatabasePool` as their first
