"""Poller detail route for the SportsQuant ops dashboard.
...
from sportsquant.infra.db.queries import get_poller_logs, get_poller_runs, get_poller_success_rates
