...
from sportsquant.models.analysis.alternate_line_eval import AlternateLineEvaluator, american_to_prob
from sportsquant.data.schemas.db import CrossReferenceDB
from sportsquant.data.schemas.player_mapping import build_player_index
from sportsquant.data.sources.draftkings.utils import american_to_prob as dk_american_to_prob
from sportsquant.data.sources.draftkings.utils import normalize_odds_string
from sportsquant.data.sources.draftkings.utils import remove_vig_two_way
...
class CrossSiteEVEngine:
    ...
    def _get_dk_storage(self):
        ...
        from sportsquant.data.sources.draftkings.storage import DraftKingsStorage

        return DraftKingsStorage(self.dk_db_path)

    def _get_fd_storage(self):
        """Get FanDuel storage instance (lazily imported)."""
        from sportsquant.data.sources.fanduel.storage import FanDuelStorage
