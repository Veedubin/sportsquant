...
Example:
    ...
    ...     NFLGameFeatures,
    ... )
    >>> from quantitative_sports.data.nfl import NFLDataPipeline
...
from quantitative_sports.util.nfl_logging import get_logger
...
class NFLGameFeatures:
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        from quantitative_sports.models.predictive.nfl_game_model import feature_columns
