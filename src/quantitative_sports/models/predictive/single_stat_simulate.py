...
def add_betting_columns_single_stat(  # pylint: disable=too-many-arguments,too-many-locals
    ...
    *,
    ...
    from quantitative_sports.core.betting.engine import expected_value, kelly_fraction  # pylint: disable=import-outside-toplevel
    from quantitative_sports.core.betting.odds import Odds  # pylint: disable=import-outside-toplevel
