"""Quant-Sports Notification System.
...
Quick Start::
    ...
    from quantitative_sports.notifications import NotificationPipeline
    ...
    from quantitative_sports.notifications import DiscordNotifier, BetNotificationData

    notifier = DiscordNotifier()
    await notifier.send_bet_alert(BetNotificationData(...))

    # Send InsightFeed with hero cards
    from quantitative_sports.notifications import build_insight_feed, BuildFeedConfig
...
from quantitative_sports.notifications.hero_card import (
    HeroCardConfig,
    generate_hero_card,
    get_hero_card_bytes,
    save_hero_card,
...
from quantitative_sports.notifications.builder import (
    BuildFeedConfig,
    build_insight_feed,
    TEAM_INFO,
    BOOK_EMOJI_MAP,
...
from quantitative_sports.notifications.renderer import (
    WebhookPayload,
    RenderedMessage,
...
from quantitative_sports.notifications.sender import (
    SendResult,
    DiscordSender,
    send_webhook,
)
...
from quantitative_sports.notifications.formatter import AlertFormatter
...
from quantitative_sports.notifications.service import (
    NotificationService,
...
from quantitative_sports.notifications.pipeline_integration import (
    EvaluatorNotifier,
...
from quantitative_sports.notifications.discord import (
    DiscordNotifier,
    NotifierHolder,
    get_notifier,
    test_notification,
...
from quantitative_sports.notifications.webhook import (
    WebhookConfig,
    BetRecommendation,
    notify_bet_placed,
    notify_steam_move,
...
from quantitative_sports.notifications.pipeline import NotificationPipeline
