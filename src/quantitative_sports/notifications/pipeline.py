"""Notification pipeline for Quant-Sports.
...
from quantitative_sports.notifications.discord import DiscordNotifier
...
class NotificationPipeline:
    ...
    This is the main entry point for all Quant-Sports notifications.
    It wires together:
    ...
    async def send_rich_bet_alert(
        ...
        """
        from quantitative_sports.notifications.models import BetNotificationData
    ...
    async def send_rich_steam_move_alert(
        ...
        Returns:
            True if sent successfully.
        """
        from quantitative_sports.notifications.models import SteamNotificationData
