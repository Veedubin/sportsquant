"""Unified Discord notification facade for Quant-Sports.
...
from quantitative_sports.notifications.hero_card import generate_hero_card
from quantitative_sports.notifications.renderer import (
    RenderedMessage,
    render_feed_to_webhook_payloads,
)
from quantitative_sports.notifications.sender import DiscordSender, SendResult

logger = logging.getLogger(__name__)

PLATFORM_NAME = "Quant-Sports"
...
def _get_webhook_url() -> str | None:
    ...
    return os.getenv("DISCORD_WEBHOOK_URL") or os.getenv("QUANT_SPORTS_DISCORD_WEBHOOK")
