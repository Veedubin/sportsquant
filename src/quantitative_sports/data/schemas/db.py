...
from quantitative_sports.util.names import normalize_name
from quantitative_sports.data.schemas.stat_mapping import to_canonical, CANONICAL_KEYS
from quantitative_sports.data.schemas.player_mapping import find_player
...
class CrossReferenceDB:
    ...
    def initialize_stat_mappings(self) -> None:
        ...
        from quantitative_sports.data.schemas.stat_mapping import get_all_site_keys
