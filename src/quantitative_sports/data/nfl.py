...
from quantitative_sports.data.sources.espn_injuries.scraper import ESPNInjuryScraper
...
class NFLDataPipeline:
    ...
    def detect_middles(
        ...
        *,
        ...
        Wraps ``quantitative_sports.core.betting.strategies.middling.detect_middles``
        ...
        """
        from quantitative_sports.core.betting.strategies.middling import detect_middles
