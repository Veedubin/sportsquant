...
def build() -> nbf.NotebookNode:
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "these opportunities using SportsQuant's middling detection module.\n"
            "\n"
            "By the end you will:\n"
            "\n"
            ...
            "- Use the `MiddlingStrategy` module from `sportsquant.core.betting.strategies`\n"
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "module from `sportsquant.core.betting.strategies.middling`."
        )
    )
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "\n"
            "SportsQuant's `detect_middles()` function combines both spread and total "
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "`sportsquant.core.betting.strategies.middling`\n"
            ...
            "|---|---|---|\n"
            "| `detect_spread_middles()` | `sportsquant.core.betting.strategies.middling` | Find spread middles |\n"
            "| `detect_total_middles()` | `sportsquant.core.betting.strategies.middling` | Find total middles |\n"
            "| `detect_middles()` | `sportsquant.core.betting.strategies.middling` | Combined detection |\n"
            "| `MiddleOpportunity` | `sportsquant.core.betting.strategies.middling` | Data class for middles |\n"
            "| `KellyCalculator` | `sportsquant.core.betting.kelly` | Kelly sizing |\n"
            "| `BankrollManager` | `sportsquant.core.betting.kelly` | Position-limited sizing |\n"
