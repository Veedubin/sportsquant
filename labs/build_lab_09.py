...
def build() -> nbf.NotebookNode:
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "\n"
            "This lab teaches you how to **extend Quant-Sports with your own betting "
    ...
    cells.append(
        nbf.v4.new_code_cell(
            ...
            "from quantitative_sports.core.betting.engine import american_to_decimal, calculate_ev\n"
            "\n"
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "\n"
            "Every betting strategy in Quant-Sports must subclass `BettingStrategy` and "
    ...
    cells.append(
        nbf.v4.new_code_cell(
            ...
            "# into the Quant-Sports poller evaluation pipeline.\n"
            "\n"
            "# 1. Create a strategy configuration (YAML-like)\n"
            "strategy_config = {\n"
            '    "name": "SteamChaser",\n'
            '    "class": "SteamChaserStrategy",\n'
            '    "module": "quantitative_sports.core.betting.strategies.custom",\n'
            '    "params": {\n'
            '        "bankroll": 5000.0,\n'
            '        "min_ev": 0.03,\n'
            '        "min_kelly": 0.01,\n'
            ...
            "# QUANT_SPORTS_POLLER_STRATEGIES=SteamChaser\n"
            "# QUANT_SPORTS_POLLER_STEAMCHASER_MIN_EV=0.03\n"
            "# QUANT_SPORTS_POLLER_STEAMCHASER_KELLY_FRACTION=0.25\n"
            "\n"
            "# In your strategy loader:\n"
            "from quantitative_sports.core.betting.strategies.base import BettingStrategy\n"
            "from quantitative_sports.core.betting.strategies.registry import StrategyRegistry\n"
            "\n"
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "`quantitative_sports/core/betting/strategies/steam_chaser.py`, add it to `__init__.py`, "
    ...
    cells.append(
        nbf.v4.new_markdown_cell(
            ...
            "|---|---|---|\n"
            "| `BettingStrategy` | `quantitative_sports.core.betting.strategies.base` | Abstract base class |\n"
            "| `BettingOpportunity` | `quantitative_sports.core.betting.strategies.base` | Input dataclass |\n"
            "| `BetDecision` | `quantitative_sports.core.betting.strategies.base` | Output dataclass |\n"
            "| `make_bet_decision` | `quantitative_sports.core.betting.strategies.base` | Helper constructor |\n"
            "| `StrategyRegistry` | `quantitative_sports.core.betting.strategies.registry` | Multi-strategy comparison |\n"
            "| `OverUnderStrategy` | `quantitative_sports.core.betting.strategies.over_under` | Pick higher EV side |\n"
            "| `ValueBettingStrategy` | `quantitative_sports.core.betting.strategies.value_betting` | Bet only on +EV |\n"
            "\n"
